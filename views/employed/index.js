...
form.addEventListener('submit', async e => {
  ...
  // await axios.patch(`/api/getEmployers/${newEmp._id}`, { service: key });
...
//   // const theId = curret.split('/');
//   // const key = theId[4];
//   const { data } = await axios.get('/api/getEmployers');
//   console.log(data);
//   // const asa = data.find(({ id }) => id === key );
//   // console.log(asa.employed);
// })();
